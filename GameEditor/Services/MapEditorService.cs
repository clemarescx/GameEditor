...
namespace GameEditor.Services
{
	...
	public class MapEditorService : IMapEditorService
	{
		...
		private Dictionary<string, LogicTile> LogicTiles = new Dictionary<string, LogicTile>();
		private Dictionary<string, TerrainTile> TerrainTiles = new Dictionary<string, TerrainTile>();
